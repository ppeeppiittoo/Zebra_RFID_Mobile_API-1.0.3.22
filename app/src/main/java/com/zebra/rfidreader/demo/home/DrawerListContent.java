...
public class DrawerListContent {
    ...
    static {
        ...
        addItem(new DrawerItem("1", "lectura Rápida", R.drawable.dl_rr));
        addItem(new DrawerItem("2", "Inventario", R.drawable.dl_inv));
        addItem(new DrawerItem("3", "Buscar Etiqueta", R.drawable.dl_loc));
        addItem(new DrawerItem("4", "Ajustes", R.drawable.dl_sett));
        //addItem(new DrawerItem("5", "Readers List",R.drawable.dl_rdl));
        addItem(new DrawerItem("5", "Control de Acceso", R.drawable.dl_access));
        addItem(new DrawerItem("6", "Pre Filtros", R.drawable.dl_filters));
        addItem(new DrawerItem("7", "Lista de lectores", R.drawable.dl_rdl));
